...
class Example1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('usb:1.9.5' if 'usb:1.9.5' else iio.get_pluto_uri(), [True, True], 32768)
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('usb:1.9.5' if 'usb:1.9.5' else iio.get_pluto_uri(), [True, True], 32768, True)
